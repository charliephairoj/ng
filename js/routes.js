angular.module('EmployeeCenter').
  config(['$routeProvider', function($routeProvider) {
    ...
    when('/accounting', {templateUrl:'partials/pages/accounting.html'}).
    ...
    when('/upholstery/add', {templateUrl:'partials/pages/products/upholstery/add_upholstery.html', controller:AddUpholsteryCtrl}).
    ...
    //Transactions
    when('/transaction', {templateUrl:'partials/pages/transaction/view.html', controller:ViewTransactionsCtrl}).
    when('/transaction/add', {templateUrl:'partials/pages/transaction/add.html', controller:AddTransactionCtrl}).
    /*
