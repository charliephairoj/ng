...
var EmployeeCenter = angular.module('EmployeeCenter', ['EmployeeCenter.filters','EmployeeCenter.services', 'EmployeeCenter.directives']).
  config(['$routeProvider', function($routeProvider) {
   ...
   // when('/upholstery', {templateUrl: 'partials/pages/view_upholsteries.html', controller: UpholCtrl}).
    ...
    when('/suppliers/:supplierID/:index', {templateUrl:'partials/pages/supplier/supplier_details.html', controller:SupplierDetailCtrl}).
    //lumber routes
    ...
    when('/lumber/:lumberID/:index', {templateUrl:'partials/pages/lumber/lumber_details.html', controller:LumberDetailsCtrl}).
    //foam routes
