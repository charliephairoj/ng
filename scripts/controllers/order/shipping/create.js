...
angular.module('employeeApp')
  .controller('OrderShippingCreateCtrl', ['$scope', 'Acknowledgement', '$filter', 'Notification', 'Shipping', '$location',
  function ($scope, Acknowledgement, $filter, Notification, Shipping, $location) {
